            ...
            <section id="">
                <div class="container">
                    ...
                    <div class="header-section mt-4">
                        <h1 class="mb-3">Choisissez votre formule d'entraînement et testez-vous en conditions réelles</h1>
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="card shadow border-0">
                                        <div class="card-body p-4">
                                            ...
                                            <p class="mb-4">Évaluez vos compétences pour l'immigration au Canada. Compréhension orale, écrite et expression</p>
                                            <ul class=" list-group-flush mb-4">
                                                <li class="list-group-item">
                                                 ...
                                                 <li class="list-group-item">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="color: rgb(167, 161, 161)"
                                                        fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                                        <path
                                                            d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                                                    </svg>
                                            ...
                                            <div id="s_abonner"  href="#!" style="border: 3px solid #224194; border-radius: 15px; width: 100%; font-size: 24px; font-weight: bold; color: #224194;"  class="btn mt-4 p-3">S’abonner</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div
                                        ...
                                        <div class="card-body p-4 p-xxl-5">
                                            ...
                                            <ul class="list-group list-group-flush mb-4">
                                                ...
                                                <li class="list-group-item">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        fill="currentColor" class="bi bi-x text-danger"
                                                        viewBox="0 0 16 16">
                                                        <path
                                            ...
                                            <a href="#!" class="btn bsb-btn-xl btn-primary rounded-pill">Choose
                                                Plan</a>
                                        </div>
                                    </div>
                                </div>
