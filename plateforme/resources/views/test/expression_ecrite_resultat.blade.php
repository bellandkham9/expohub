                                ...
                                <div class="row g-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="task-navigation">
                                                    ...
                                                    <div class="list-group">
                                                        ...
                                                        <a href="#task-{{ $index + 1 }}" class="list-group-item list-group-item-action task-link @if ($loop->first) active @endif" data-bs-toggle="tab" data-task="{{ $index + 1 }}">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <span>Tâche {{ $index + 1 }}</span>
                                                                @if (isset($reponses[$index]->score))
                                                                <span class="badge bg-{{ $reponses[$index]->score >= 0.5 ? 'success' : 'warning' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="tab-content">
                                            @foreach ($taches as $index => $tache)
                                            <div class="tab-pane fade @if ($loop->first) show active @endif" id="task-{{ $index + 1 }}">
                                                <div class="card shadow-sm rounded-lg border-0 mb-4">
                                                    <div class="card-header bg-primary text-white">
                                                        <p class=" mb-0"><span style="font-size: 18px; font-weight: bold;">Tâche
                                                                {{ $index + 1 }}:</span>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-4">
                                                            <h5 class="fw-bold border-bottom pb-2">
                                                                <i class="fas fa-info-circle me-2 text-muted"></i>Contexte
                                                            </h5>
                                                            <div class="bg-light p-3 rounded border">
                                                        ...
                                                        <div class="mb-4">
                                                            <h5 class="fw-bold border-bottom pb-2">
                                                                <i class="fas fa-user-edit me-2 text-muted"></i>Votre
                                                                réponse
                                                            </h5>
                                        ...
                                        <div class="text-center mt-4">
                                            <a href="{{ route($route) }}" class="btn btn-primary px-4 py-2">
