...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Préparez vos tests TCF, TEF, DELF et DALF sur ExpoHub Academy, la meilleure plateforme interactive pour améliorer votre français.')">
    <meta name="keywords" content="@yield('meta_keywords', 'plateforme TCF Canada, test de français, compréhension écrite, compréhension orale, expression écrite, expression orale, préparation TEF, DELF, DALF, français en ligne')">
    <meta name="author" content="ExpoHub Academy">

    <meta property="og:title" content="@yield('meta_title', 'ExpoHub Academy - Préparez vos tests de français')">
    <meta property="og:description" content="Entraînez-vous pour le TCF Canada, TEF et DELF sur une plateforme interactive alimentée par l’IA.">
    <meta property="og:image" content="{{ asset('images/logo.png') }}">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta name="twitter:card" content="summary_large_image">


    <title>Expohub | test-TCF Expression Orale</title>
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/expression_ecrite-BhbBQVKC.css') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/myExpressionEcrite-DmdomTqK.css') }}">
